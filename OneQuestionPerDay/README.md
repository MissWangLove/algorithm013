...
第三遍实现，发现做起来还算流畅，一次就做出来，还不错，喜欢这种感觉。
...
第三遍组，忘记中序遍历怎么写了，吐血呀，难受，香菇，可能是做dfs和bfs做多了，脑子马上反应不过来把，难受的一批，继续加油，三遍不行就四遍，
四遍不行就五遍，一遍一遍练，我就不信了。
...
第三遍提交，虽然写法有问题，但是思路没有问题，顺利做下来，都是递归的使用。
...
第三遍做，完全遗忘，连思路都没有了，可怕的一匹，于是看了第二遍的题解，算是稍微有点印象，但是做的时候又出现了一些小问题，对于
first的理解不到位，在计算的过程中出错。这个还得多练几遍。
...
昨晚做了，但是写出来之后发现超时了，并且代码量和算法也有问题，所以今天看了官方题解的bfs，然后修正了下自己的代码， 明天再写一遍，应该就可以了。
今天忙了一天工作上的代码，所以做题比较晚。继续加油

第二遍作品，先使用bfs，顺利做出来，然后使用dfs，遇到一些问题，总是想着在递归的时候统计周围炸弹的数量，就形成了死循环，永远不会结束，应该先统计
炸弹的个数，改变值之后再递归，这个是我的问题，记录一下，当前层业务的错误导致。递归的四大要点没有掌握到位。

#### 27. 根到叶路径上的不足节点

这道题虽然最后没做出来，但是是细节没有处理好，对终止条件没有理解到位，其实算自己做出来，就是在递归的时候判断了下num < limit的时候，忘记判断
大的时候的情况，所以总是有点小瑕疵，但是最重要的是思路是完全正确的，绝对没有问题，这才是重点，哈哈。继续加油了。

第二遍提交，很顺利就做下来，还不错，第一遍的原因找到，第二遍就很容易做下来。

#### 28. 跳跃游戏

第一次做跳跃游戏，看了视频，但是没按照视频的贪心算法来求解，利用了投机取巧，根据0的个数来进行判断，只要能跳过0到达下一位，并且0不是最后一位就好。
思路简单，代码也不难，今天的每日一题完成，接下来复习一下昨天的题目。

第二遍做，可能是有点晚，头有点晕，所以想了好一会，才想出来，并优化了昨天的写法，还不错，独立做题的感觉很棒。

第三遍做，发现有点乐趣，自己写出来了，都不知道为什么对，想了好了一会才发现那个循环的长度有点意思，哈哈。

#### 29. 单词接龙

第一遍提交单词接龙，说实话，这道题在我上周就打算做，但是发现没有思路，就没做，到了今天班班的每日一题就是这个，于是就说这次无论也要做下来，于是就
开始思考，但是今天莫名其妙有了思路，利用bfs来做，完全没有问题呀，于是就开始写，一遍写出来并完美通过运行，这种感觉很棒，真的。

#### 30. 两数之和

暴力求解没问题，顺手拈来，但是一遍hash做的时候就有点犹豫了，有点遗忘，再做一遍。

#### 31. 搜索旋转排序数组

这道题有思路，但是思路并不是很好，看视频，看题解，找到了比较清晰的思路和代码，基本没有啥问题，只要想清楚边界，标准的二分查找就可以解决。
明天继续做。

第二遍做搜索旋转排序数组，过了好久了感觉，最近几天工作太忙，所以呢，每天只保证做了一道题，很多题都没有复习。第二遍做少考虑了等号的情况，
不过及时弥补了。